...
location_table: Dict[str, UT2LocationData] = {
    ...
    "#26 Jinx&Punchbuggy Card":                             UT2LocationData("boss", "Beach Post Boss", 326),
    ...
    "#55 Jamanda Friglounge Card":                          UT2LocationData("boss", "Beach Relax 8", 355),
    ...
    "Aquarium - Whale Shark Onesie":                        UT2LocationData("aquarium", "Aquarium", 524),
